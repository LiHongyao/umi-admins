...
function audioToHtml(elem: SlateElement, childrenHtml: string): string {
  ...
  const html = `<div data-w-e-type="audio" data-w-e-is-void data-src=${src} style="padding: 16px 8px; background:linear-gradient(45deg,#f5f5f5 70%,transparent 0,transparent 80%,#f5f5f5 0,#f5f5f5);">\n
