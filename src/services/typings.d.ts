declare namespace API {
  /**********************
   ** 基础APIs
   ** 1.基础响应格式：BaseResponse<string>
   ** 2.对象响应格式：BaseResponse<{ token: string }
   ** 3.数组响应格式：BaseResponse<Array<string>>
   ** 4.分页响应格式：BaseResponse<Page<{ name: string, value: number }>>
   ** 5.分页交叉格式：BaseResponse<Page<{ name: string, value: number }> & { count: number }>
   **********************/
